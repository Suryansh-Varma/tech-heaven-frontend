...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-slate-200/80 bg-white px-5 py-6 transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        {/* Footer info */}
        <div className="border-t border-slate-100 pt-4 px-3 flex items-center justify-between text-[11px] font-semibold text-slate-400">
